    ...
    if (!empty($updates->response)) {
        ...
        if ($updates_needed) {
            echo '<div style="border: 1px solid #F6C6CA; border-radius: 5px; background-color: #F9D7DA; color: #721C23; padding: 15px; margin: 20px 20px 20px 0px; font-size: 16px;">
                ...
                <p><strong>Nechte to na nás:</strong><br>Objednejte si naši službu 
                        ...
                        a my se o aktualizace a bezpečí vašeho webu postaráme kompletně za vás. Získáte tak bezstarostný provoz a vždy aktuální systém.</p>
                <p><strong>Aktualizujte si systém sami:</strong><br>Pokud máte administrátorský přístup, můžete aktualizace provést svépomocí. Po aktualizaci doporučujeme důkladně otestovat funkčnost webu.
                    </p>
